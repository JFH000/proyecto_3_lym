// DO NOT EDIT THIS FILE! IT IS AUTOMATICALLY GENERATED FROM FILE "src/Lexer202510.gold"
import gold.*;
...
public final class Lexer202510 {
  ...
  static {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,null,$line);
    }
  }
  ...
  public static Object chars(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"chars",$line);
    }
    return $result;
  }
  public static Object charsStrings(Object strings) {
    ...
    $try:try {
      ...
      $v6:for (Object s:GCollections.unmodifiableCollection(strings)) {
        $v5.union(GCollections.unmodifiableSet(((java.lang.Iterable)(Lexer202510.chars(s)))));
      }
      $result=$v5;
      if (true) break $try;
      $line=33;
      ...
      $rethrow($throwable,Lexer202510.class,"charsStrings",$line);
    }
    return $result;
  }
  public static Object elements(Object array) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"elements",$line);
    }
    return $result;
  }
  public static Object prefixes(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"prefixes",$line);
    }
    return $result;
  }
  public static Object splits(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"splits",$line);
    }
    return $result;
  }
  public static Object allPrefixes(Object strings) {
    ...
    $try:try {
      ...
      $v20:for (Object s:GCollections.unmodifiableCollection(strings)) {
        $v19.union(GCollections.unmodifiableSet(((java.lang.Iterable)(Lexer202510.prefixes(s)))));
      }
      $result=$v19;
      if (true) break $try;
      $line=40;
      ...
      $rethrow($throwable,Lexer202510.class,"allPrefixes",$line);
    }
    return $result;
  }
  public static Object translationGet(Object q) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"translationGet",$line);
    }
    return $result;
  }
  public static Object runLexer(Object M, Object input) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"runLexer",$line);
    }
    return $result;
  }
    ...
    $try:try {
      ...
      if ($opMembrY(q,allSymbols)) {
        ...
        if ($opLessqY($opAbsolY(q),1)) {
          ...
          $line=56;
          for (Object $v21:GCollections.unmodifiableCollection(Lexer202510.splits(q))) {
            java.util.Iterator $v22=GCollections.unmodifiableCollection($v21).iterator();
            Object s=$v22.next();
            Object t=$v22.next();
            $line=57;
            if ((!$bool(Lexer202510.problems($cast(java.lang.String.class,s)))&&!$bool(Lexer202510.problems($cast(java.lang.String.class,t))))) {
              $line=57;
              $result=false;
              if (true) break $try;
            }
      ...
      $rethrow($throwable,Lexer202510.class,"problems",$line);
    }
    return $result;
  }
  public static Object translationPreOps(Object state) {
    ...
    $try:try {
      ...
      if ($opEqualY(n,0)) {
        ...
        if ($opMembrY(q,allSymbols)) {
          ...
          if ($opEqualY(n,1)) {
            ...
            $line=76;
            for (Object $v23:GCollections.unmodifiableCollection(Lexer202510.splits(q))) {
              java.util.Iterator $v24=GCollections.unmodifiableCollection($v23).iterator();
              Object s=$v24.next();
              Object t=$v24.next();
              $line=77;
              x=$fix(Lexer202510.translationPreOps(s));
              $line=78;
              y=$fix(Lexer202510.translationPreOps(t));
              $line=79;
      ...
      $rethrow($throwable,Lexer202510.class,"translationPreOps",$line);
    }
    return $result;
  }
  public static ITransducer createLexer() {
    ...
    $try:try {
      $line=91;
      Lexer202510.initialize();
      $line=93;
      preOps=$cast(ISet.class,$fix(Lexer202510.allPrefixes(allSymbols)));
      $line=94;
      preKW=$cast(ISet.class,$fix(Lexer202510.allPrefixes(keyWords)));
      $line=95;
      ...
      $rethrow($throwable,Lexer202510.class,"createLexer",$line);
    }
  ...
  public static Object \u03B4(Object state, Object \u03C3) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"\u03B4",$line);
    }
    return $result;
  }
  public static Object g(Object q) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"g",$line);
    }
    return $result;
  }
  public static Object h(Object q, Object \u03C3) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Lexer202510.class,"h",$line);
    }
    return $result;
  }
